    ...
    <div className="align-items-center d-flex login-container justify-content-center">
        <form className="login-form col-12">
            <div className="mb-3">
                ...
                />
                <label className="mt-1" htmlFor="login-email">Email address</label>
            </div>
            <div>
                <input 
                    type="password" 
                ...
                />
                <label className="mt-1" htmlFor="login-password">Password</label>
            </div>
            ...
            <p className="mt-5 text-body-secondary text-center">&copy; 2024–{currentYear}</p>
        </form>
    </div>
);